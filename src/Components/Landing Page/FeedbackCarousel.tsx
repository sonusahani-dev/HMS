        ...
        <div className="col-lg-10 py-5 mx-auto">
          <div className="row mb-3">
            <div className="col-sm-6 mx-auto ">
              <h1 className='my-color2 fw-bold text-center' style={{fontSize:"55px"}}>We served over 5000+ Patients</h1>
        ...
        <p className='my-color1 mb-3 text-center' style={{fontSize:"20px",lineHeight:"35px"}}> Lets know moreel necessitatibus dolor asperiores illum possimus sint voluptates incidunt molestias nostrum laudantium. Maiores porro cumque quaerat.</p>
          ...
          <div className="row mt-5">
            <div className="col-lg-10 mx-auto">
              <div className="row">
                <div className="col-md-6 px-3 mb-3" style={{position:"relative"}}  >
                  <div className="div mb-3 p-5 rounded-4" style={{background:"white"}}>
                    ...
                    <p className='my-color1 mt-3' style={{fontSize:"20px",lineHeight:"35px"}}> 
